...
#define PYSOY_TYPEINIT_PROP(M, C, T, P, GETTER, SETTER, CHECKTYPE) do {\
    ...
    ((PySoy__GeeMap_Object*) py)->get = (void*) GETTER;\
    ((PySoy__GeeMap_Object*) py)->set = (void*) SETTER;\
    ((PySoy__GeeMap_Object*) py)->check_type = (void*) CHECKTYPE;\
    g_object_ref(g);\
...
typedef struct {
    PyObject_HEAD
    soybodiesCylinder* g;
} PySoy_bodies_Cylinder_Object;
#define PySoy_bodies_Cylinder_Check(op) \
    PyObject_TypeCheck(op, &PySoy_bodies_Cylinder_Type)
...
typedef struct {
    PyObject_HEAD
    soybodiesPortal* g;
} PySoy_bodies_Portal_Object;
#define PySoy_bodies_Portal_Check(op) \
    PyObject_TypeCheck(op, &PySoy_bodies_Portal_Type)
...
// soy.materials.Wireframed
PyTypeObject  PySoy_materials_Wireframed_Type;
typedef struct {
    PyObject_HEAD
    soymaterialsWireframed* g;
} PySoy_materials_Wireframed_Object;
#define PySoy_materials_Wireframed_Check(op) \
    PyObject_TypeCheck(op, &PySoy_materials_Wireframed_Type)
...
typedef struct {
    PyObject_HEAD
    soyscenesPlanar* g;
} PySoy_scenes_Planar_Object;
#define PySoy_scenes_Planar_Check(op) \
    PyObject_TypeCheck(op, &PySoy_scenes_Planar_Type)

// soy.scenes.Landscape
PyTypeObject  PySoy_scenes_Landscape_Type;
typedef struct {
    PyObject_HEAD
    soyscenesLandscape* g;
} PySoy_scenes_Landscape_Object;
#define PySoy_scenes_Landscape_Check(op) \
    PyObject_TypeCheck(op, &PySoy_scenes_Landscape_Type)
...
// soy.textures.Cubemap
PyTypeObject  PySoy_textures_Cubemap_Type;
typedef struct {
    PyObject_HEAD
    soytexturesCubemap* g;
} PySoy_textures_Cubemap_Object;
#define PySoy_textures_Cubemap_Check(op) \
    PyObject_TypeCheck(op, &PySoy_textures_Cubemap_Type)

// soy.textures.Bumpmap
PyTypeObject  PySoy_textures_Bumpmap_Type;
typedef struct {
    PyObject_HEAD
    soytexturesBumpmap* g;
} PySoy_textures_Bumpmap_Object;
#define PySoy_textures_Bumpmap_Check(op) \
    PyObject_TypeCheck(op, &PySoy_textures_Bumpmap_Type)

// soy.textures.Heightmap
PyTypeObject  PySoy_textures_Heightmap_Type;
typedef struct {
    PyObject_HEAD
    soytexturesHeightmap* g;
} PySoy_textures_Heightmap_Object;
#define PySoy_textures_Heightmap_Check(op) \
    PyObject_TypeCheck(op, &PySoy_textures_Heightmap_Type)
