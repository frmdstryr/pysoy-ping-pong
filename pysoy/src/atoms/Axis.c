...
"\n"
"    :param float x: The x value of the axis\n"
"    :param float y: The y value of the axis\n"
"    :param float z: The z value of the axis\n"
"\n";
...
"\n"
"   float value that describes the x position of the axis\n";
...
"\n"
"   float value that describes the y position of the axis\n";
...
"\n"
"   float value that describes the z position of the axis\n";
