...
static char
tp_doc[] = ".. py:class:: Universal(src, dst, anchor, axis1, axis2)\n"
"\n"
"    Universal joints restrict the position and orientation of their\n"
"    connected bodies along two perpendicular axis at an anchor.\n"
"\n"
"    Example::\n"
"\n"
"        >>> s = soy.scenes.Scene()\n"
...
"        >>> j = soy.joints.Universal(b, b2, anchor, axis1, axis2)\n"
"        >>> j\n"
"        >>> <Universal Joint>\n"
"\n"
...
tp_new(PyTypeObject* type, PyObject* args, PyObject* kwds) {
    ...
    if(!bodyTwo)
        self->g = soy_joints_universal_new(bodyOne->g, NULL,
                                           anchor->g, axis1->g, axis2->g,
                                           NULL);
    else
        self->g = soy_joints_universal_new(bodyOne->g, bodyTwo->g,
                                           anchor->g, axis1->g, axis2->g,
                                           NULL);
...
static char anchor_doc[] = ".. py:attribute:: Universal.anchor\n"
"\n"
"    The :class:`~soy.atoms.Position` of the joint's perpendicular pins.\n"
"\n"
...
static char axis1_doc[] = ".. py:attribute:: Universal.axis1\n"
"\n"
"    The :class:`~soy.atoms.Axis` of the first pin.\n"
"\n"
"    This will always be perpendicular to :attr:`Universal.axis2`\n"
"    regardless to whether the joint's destination is a body or scene.\n"
"\n";
PYSOY_PROP_OBJECT_OWNED(joints, universal, axis1, atoms_Axis);


static char axis2_doc[] = ".. py:attribute:: Universal.axis2\n"
"\n"
"    The :class:`~soy.atoms.Axis` of the second pin.\n"
"\n"
"    When connected to two bodies this will float respective both bodies,\n"
"    while when connecting a body to its scene this will remain fixed.\n"
"    In either case :attr:`Universal.axis1` will remain perpendicular to\n"
"    this axis.\n"
"\n";
